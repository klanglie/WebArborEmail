========================================================================
    ACTIVE TEMPLATE LIBRARY : WebArborEmail Project Overview
========================================================================

AppWizard has created this WebArborEmail project for you to use as the starting point for
...
_WebArborEmail.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_WebArborEmail.h)
        GUID definitions                                (_WebArborEmail_i.c)
        A type library                                  (_WebArborEmail.tlb)
        Marshaling code                                 (_WebArborEmail_p.c and dlldata.c)
...
StdAfx.h, StdAfx.cpp
    ...
    named WebArborEmail.pch and a precompiled types file named StdAfx.obj.
...
WebArborEmailps.vcproj
	...
	dlldata.c, WebArborEmail_i.c and WebArborEmail_p.c which are required
